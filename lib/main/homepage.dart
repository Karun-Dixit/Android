...
class _HomeWidget extends State<HomePage>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(title: const Text("Karun-NotePad",style: TextStyle(color: Colors.white),),centerTitle: true,backgroundColor: Colors.black, iconTheme: const IconThemeData(color: Colors.white),),
      drawer: Drawer(
        ...
        child: ListView(padding: EdgeInsets.zero, children: <Widget>[ const DrawerHeader(decoration: BoxDecoration(color: Colors.black,),
            child: Align(alignment: Alignment.centerLeft,child: Text('X-NotePad', style: TextStyle(color: Colors.white, fontSize: 24,),),)),
          ...
          ListTile(
            ...
            title: const Text('Go to browser',style: TextStyle(fontSize: 14,color: Colors.black),),
            onTap: () {
